  ...
  _createClass(Connection, [{
    ...
    value: function request(path) {
      ...
      return fetch(this.baseUrl + path, req).catch(function (err) {
        ...
        if (!requestId) {
          throw errors.create(errors.types.NO_REQUEST_ID, 'Chain-Request-Id header is missing. There may be an issue with your proxy or network configuration.', { response: resp });
        }
